 ...
 */
class ByteStreamBuildEventArtifactUploaderFactory2 implements
  ...
  ByteStreamBuildEventArtifactUploaderFactory2(
  ...
  public BuildEventArtifactUploader create(CommandEnvironment env) {
    return new ByteStreamBuildEventArtifactUploader2(
        blobstore,
        ctx,
