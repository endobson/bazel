 ...
 */
class ByteStreamBuildEventArtifactUploader2 implements BuildEventArtifactUploader {
  ...
  ByteStreamBuildEventArtifactUploader2(
  ...
  public ListenableFuture<PathConverter> upload(Map<Path, LocalFile> files) {
      ...
      ListenableFuture<PathDigestPair> digestFuture =
          Futures.transformAsync(
              ...
              isDirectory -> {
                ...
                try {
                  upload = blobstore.uploadFile(digest, file);
                } finally {
                  ctx.detach(prevCtx);
                }
    ...
    return Futures.transform(
        ...
        pathDigestPairs -> new PathConverterImpl(pathDigestPairs),
        MoreExecutors.directExecutor());
  }
  ...
  private static class PathConverterImpl implements PathConverter {
    ...
    PathConverterImpl(List<PathDigestPair> uploads) {
    ...
    public String apply(Path path) {
      ...
      return String.format("http://localhost:9100/cas/%s", digest.getHash());
    }
  }
